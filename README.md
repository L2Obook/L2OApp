...
| **第二章: 单目标学习优化方法** | 2.1 预备知识 |  xxx | xxx | xxx |
|  | 2.2 利用知识蒸馏的可泛化方法 | xxx | xxx | xxx |
|  | 2.3 基于偏好优化的训练范式 | xxx | xxx | xxx |
| **第三章: 多目标学习优化方法** | 3.1 预备知识 |  xxx | xxx | xxx |
|  | 3.2 高效元学习方法 | xxx | xxx | xxx |
|  | 3.3 权重嵌入方法 | xxx | xxx | xxx |
|  | 3.4 多模态特征融合方法 | xxx | xxx | xxx |
|  | 3.5 多样性增强方法 | xxx | xxx | xxx |
|  | 3.6 权重相关的学习提升方法 | xxx | xxx | xxx |
| **第四章: 动态鲁棒问题的学习优化方法** | 4.1 动态问题的学习优化方法 |  xxx | xxx | xxx |
|  | 4.2 鲁棒问题的学习优化方法 | xxx | xxx | xxx |
| **第五章: 学习优化约束处理方法** | 5.1 两阶段约束处理方法 |  xxx | xxx | xxx |
|  | 5.2 可行性和多样性引导的约束处理方法 | xxx | xxx | xxx |
|  | 5.3 基于偏好优化的约束处理方法 | xxx | xxx | xxx |
| **第六章: 迈向学习优化基础模型** | 6.1 知识共享的专家组合方法 | xxx | xxx | xxx |
|  | 6.2 端到端学习优化基础模型 | xxx | xxx | xxx |
|  | 6.3 总结和展望 | xxx | xxx | xxx |

| 章节 | 节 | 论文 | 源码 | 备注 |
|------|----------|----------|----------|----------|
| **第一章：绪论** |  |  |  |  |
| 1.1 优化问题与优化方法概述 | xxxx | xxx | xxx | xxx |
|  1.2 机器学习方法概述 | xxx | xxx | xxx | xxx |
|   1.3 优化与学习的融通共进 | xxx | xxx | xxx | xxx |
|   1.4 面向组合优化的学习优化方法研究进展 | xxx | xxx | xxx | xxx |
|   1.4 面向组合优化的学习优化方法研究进展 | xxx | xxx | xxx | xxx |
| **第二章: 单目标学习优化方法** |  |   |  |  |
| 2.1 预备知识 | xxxx |  xxx | xxx | xxx |
...
| 章 | 节 | 论文 | 源码 | 备注 |
|------|----------|----------|----------|----------|
| **第一章：绪论** 1.1 优化问题与优化方法概述 | xxxx | xxx | xxx | xxx |
|   1.2 机器学习方法概述 | xxx | xxx | xxx | xxx |
|   1.3 优化与学习的融通共进 | xxx | xxx | xxx | xxx |
|   1.4 面向组合优化的学习优化方法研究进展 | xxx | xxx | xxx | xxx |
| **第二章: 单目标学习优化方法**  2.1 预备知识 | xxxx |  xxx | xxx | xxx |
|   2.2 利用知识蒸馏的可泛化方法 | xxx | xxx | xxx | xxx |
|   2.3 基于偏好优化的训练范式 | xxx | xxx | xxx | xxx |
